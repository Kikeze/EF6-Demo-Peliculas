    ...
    public partial class DatosDePrueba : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                table: "Actores",
                columns: new[] { "Id", "Biografia", "Nacimiento", "Nombre" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Peliculas",
                columns: new[] { "Id", "EnCartelera", "Estreno", "PosterURL", "Titulo" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "CinesOfertas",
                columns: new[] { "Id", "CineId", "Descuento", "Final", "Inicio" },
                values: new object[,]
                {
                    { 1, 1, 10m, new DateTime(2022, 10, 7, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 9, 30, 0, 0, 0, 0, DateTimeKind.Local) },
                    { 2, 4, 15m, new DateTime(2022, 10, 5, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 9, 30, 0, 0, 0, 0, DateTimeKind.Local) }
                });
            ...
            migrationBuilder.InsertData(
                table: "SalasCine",
                columns: new[] { "Id", "CineId", "Precio", "Tipo" },
                values: new object[,]
                {
                    { 1, 1, 220m, 1 },
                    { 2, 1, 320m, 2 },
